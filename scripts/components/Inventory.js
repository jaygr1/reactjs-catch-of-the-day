...
//
// const ref = new Firebase('https://catch-of-the-day-learn.firebaseio.com/')
//
// @autobind
...
//     ref.authWithOauthPopup(provider, function(err, this.authHandler)
//   }
//
//   componentWillMount() {
//     console.log("check");
...
//     }
//
//     // save login token in broswer
//     localStorage.setsetItem('token', authData.token)
//
//     cons storeRef = ref.child(this.props.params.storeId)
//     storeRef.on('value', (snapshot)=> {
//       var data = snapshot.val() || {};
//
//       //claim if now owner already
//       if(!data.owner) {
//         storeRef.set({
//           owner : authData.uid
//         })
//       }
//
//       //update to reflect current owner / user
//       this.setState({
//         uid : authData.uid
...
//       <nav className="login">
//         <h2>Inventory</h2>
//         <p>Sign in to manager your inventory</p>
...
//         <input type='textarea' valueLink={linkState('fishes.' + key + '.image')} />
